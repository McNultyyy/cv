...
{ICBC Standard Bank Plc}{Software Developer}{}{}
{
	...
	\begin{itemize}
		\item Worked as part of a small team to create an in-house incident reporting application, known as ORIS, which allowed users to raise incidents following specific business workflows.\\
		...
		\item Have set up many scheduled and adhoc file transfers by using the GoAnywhere's \textregistered MFT solution.
